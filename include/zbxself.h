...
#define ZBX_PROCESS_TYPE_IPMIPOLLER	1
#define ZBX_PROCESS_TYPE_PINGER		2
#define ZBX_PROCESS_TYPE_JAVAPOLLER	3
#define ZBX_PROCESS_TYPE_HTTPPOLLER	4
#define ZBX_PROCESS_TYPE_TRAPPER	5
#define ZBX_PROCESS_TYPE_SNMPTRAPPER	6
...
#define ZBX_PROCESS_TYPE_DATASENDER	14
#define ZBX_PROCESS_TYPE_CONFSYNCER	15
#define ZBX_PROCESS_TYPE_HEARTBEAT	16
